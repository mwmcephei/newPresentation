            ...
            for (let i = 0; i < artefacts.length; i++) {
                ...
                if (artefacts[i].budget.length > 0) {
                    if (artefacts[i].budget.substring(0, 1) === "€") {
                        budgetAsNumber = parseInt(artefacts[i].budget.substring(1, artefacts[i].budget.length - 2)) * 1000
                    } else if (artefacts[i].budget.substring(0, 2) === "€ ") {
                        budgetAsNumber = parseInt(artefacts[i].budget.substring(2, artefacts[i].budget.length - 2)) * 1000
                    } else if (artefacts[i].budget.substring(0, 2) === " €") {
                        budgetAsNumber = parseInt(artefacts[i].budget.substring(2, artefacts[i].budget.length - 2)) * 1000
                    } else if (artefacts[i].budget.substring(0, 3) === "  €") {
                        budgetAsNumber = parseInt(artefacts[i].budget.substring(4, artefacts[i].budget.length - 2)) * 1000
                    } else {
                        budgetAsNumber = parseInt(artefacts[i].budget.substring(0, artefacts[i].budget.length - 2)) * 1000
                    }
                }
