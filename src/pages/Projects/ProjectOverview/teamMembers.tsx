          ...
          <Table className="table align-middle table-nowrap">
            <tbody className="">
              <tr>
                ...
                <td>
                  <h5 className="font-size-14 m-0">
                    <div>{divideName(props.lead).firstName}</div>
                    <div>{divideName(props.lead).lastName}</div>
                  </h5>
                </td>
                <td>
                  <div>
              ...
              <tr>
                ...
                <td>
                  <h5 className="font-size-14 m-0">
                    <div>{divideName(props.measureSponsor).firstName}</div>
                    <div>{divideName(props.measureSponsor).lastName}</div>
                  </h5>
                </td>
                <td>
                  <div>
