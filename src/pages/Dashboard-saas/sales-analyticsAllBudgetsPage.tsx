...
import { OldMeasuresCategoryAmountAndBudget } from 'types';

interface SalesAnalyticsProps {
  title: string;
  data: OldMeasuresCategoryAmountAndBudget[];
  isQuantity: boolean;
}
...
const SalesAnalytics = ({
  ...
  data,
  isQuantity,
}: SalesAnalyticsProps): ReactElement => {
    ...
    tooltip: {
      ...
      y: {
        ...
        formatter: function (value, { series, seriesIndex, dataPointIndex, w }) {
          return !isQuantity ? structureNumberForDisplay(value, true) + " kEUR" : value
        },
      },
    },
    legend: { show: !1 },
                    ...
                    <div
                      className={
                        window.innerWidth < 1400
                          ? 'ml-4 d-flex justify-content-around'
                          : ''
                      }
                    >
